...
Dir.glob(File.dirname(__FILE__) + '/background_lite/handlers/*.rb').each do |handler|
  require handler
end
Dir.glob(File.dirname(__FILE__) + '/background_lite/error_reporters/*.rb').each do |reporter|
  require reporter
end
